...
<Steps>
  ...
  3. Navigate to **Apps → Stardate**
  
  4. Inside this folder, you'll find all your recordings and transcriptions, organized by date
</Steps>
...
<Steps>
  ...
  4. Navigate to **Apps → Stardate**
  
  5. Your recordings and transcriptions will appear here
</Steps>
